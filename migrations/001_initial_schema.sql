...
VALUES
  ...
  (
    ...
    338,
    '{"strength": 6, "agility": 2}'::jsonb,
    NOW()
  ),
  (
    'skillbook-focus-strike',
    '技能书·凝神重击',
    'white',
    'skill_book',
    'focus-strike',
