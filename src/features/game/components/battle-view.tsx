  ...
  return (
    <div className="rounded-lg p-3 flex flex-col" style={{
      ...
      <div className="flex items-center gap-2 mb-2">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center text-base shrink-0" style={{ background: side === 'player' ? '#238636' : '#f8514920' }}>
          {alive ? icon : '💀'}
        </div>
      ...
      {/* buff 区域固定高度 */}
      <div className="flex gap-1 flex-wrap mt-auto" style={{ minHeight: 20 }}>
        {effects.map((eff, i) => (
